const addCustomReaction = (
  <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" fill="currentColor" className="bi bi-clipboard-heart" viewBox="0 0 16 16">
...
export default addCustomReaction;
